...
MS2_VAR_PUBLIC MSFilterDesc ms_analyse_display_desc;
...
MS2_VAR_PUBLIC MSFilterDesc ms_video_router_desc;
MS2_VAR_PUBLIC MSFilterDesc ms_dummy_enc_desc;
MS2_VAR_PUBLIC MSFilterDesc ms_dummy_dec_desc;
...
MS2_VAR_PUBLIC MSFilterDesc ms_turbojpeg_mjpeg_dec_desc;
MS2_VAR_PUBLIC MSFilterDesc ms_mfoundation_read_desc;
MS2_VAR_PUBLIC MSFilterDesc ms_jpeg_writer_desc;
MS2_VAR_PUBLIC MSFilterDesc ms_ogl_desc;
MS2_VAR_PUBLIC MSFilterDesc ms_Av1Decoder_desc;
MS2_VAR_PUBLIC MSFilterDesc ms_Av1Encoder_desc;
...
&ms_pix_conv_desc,
&ms_size_conv_desc,
&ms_video_router_desc,
&ms_dummy_enc_desc,
&ms_dummy_dec_desc,
&ms_dd_display_desc,
&ms_vp8_enc_desc,
&ms_vp8_dec_desc,
&ms_turbojpeg_mjpeg_dec_desc,
&ms_mfoundation_read_desc,
&ms_jpeg_writer_desc,
&ms_ogl_desc,
&ms_Av1Decoder_desc,
&ms_Av1Encoder_desc,
