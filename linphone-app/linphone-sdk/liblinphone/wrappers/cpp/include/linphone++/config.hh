...
namespace linphone {
	...
	class Config: public Object {
		...
		public:
			...
			/**
			 * @brief Indicates whether the LinphoneConfig object is readonly, in other words
			 ...
			 * @param section The section from which to retrieve a configuration item    
			 * @param key The name of the configuration item to retrieve    
			 * @param min The min value found or default_min    
			 * @param max The max value found or default_max    
			 * @param defaultMin the default min value to return if not found 
			 ...
			 * @param section The section from which to retrieve a configuration item    
			 * @param key The name of the configuration item to retrieve    
			 * @param minValue the min value to set 
			 ...
			 * configuration file. 
			 *
			 * @param filename Name of the file where to write data. The name is relative to
...
;
			 ...
			 * The caller of this constructor owns a reference. linphone_config_unref must be
			 * called when this object is no longer needed.
			 * @param configFilename the filename of the user config file to read to fill the
