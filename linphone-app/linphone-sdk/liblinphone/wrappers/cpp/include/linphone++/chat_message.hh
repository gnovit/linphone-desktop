...
#ifndef _CHAT_MESSAGE_HH
#define _CHAT_MESSAGE_HH
...
namespace linphone {
	 ...
	 * Keep in mind a @ref ChatMessage created by a @ref ChatRoom::Backend::Basic @ref
	...
	class ChatMessage: public MultiListenableObject {
		...
		public:
			...
			/**
			 * @brief Returns our own reaction for a given chat message, if any. 
			 *
			 * @return Our own @ref ChatMessageReaction for that message if any, nullptr
			 * otherwise.    
			 */
			LINPHONECXX_PUBLIC std::shared_ptr<const linphone::ChatMessageReaction> getOwnReaction() const;
			
			/**
			 * @brief Gets the list of reactions received for this chat message. 
			 *
			 * Warning: list is ordered by content of reaction message, not by received
			 * timestamp! 
			 * @return The sorted list of reaction if any.         
			 */
			...
			/**
			 * @brief Returns the address of the sender of the message this is a reply to. 
			 *
			...
			/**
			 * @brief Creates a emoji reaction for the given chat mesage. 
			 *
			 * To send it, use ChatMessageReaction::send(). 
			 * @param utf8Reaction the emoji character(s) as UTF-8.    
			 * @return a @ref ChatMessageReaction object.    
			 */
